...
static inline void SaSi_PalLogLevelSet(int setLevel)
{
    SASI_UNUSED_PARAM(setLevel);
}
static inline void SaSi_PalLogMaskSet(uint32_t setMask)
{
    SASI_UNUSED_PARAM(setMask);
}
#endif
#endif
