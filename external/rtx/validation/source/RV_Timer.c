...
void Timer_IRQHandler (void)
{
    switch (ISR_ExNum) {
    case 0:
        TimId_Isr = osTimerCreate (osTimer (Tim_Dummy), osTimerOnce,     NULL);
        break;
    case 1:
        TimId_Isr = osTimerCreate (osTimer (Tim_Dummy), osTimerPeriodic, NULL);
        break;
    case 2:
        TimSt_Isr = osTimerStart  ((TimId_Running), 100);
        break;
    case 3:
        TimSt_Isr = osTimerStop    (TimId_Running);
        break;
    case 4:
        TimSt_Isr = osTimerDelete  (TimId_Running);
        break;
    }
}
