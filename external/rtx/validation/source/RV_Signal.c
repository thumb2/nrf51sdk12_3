...
void Signal_IRQHandler (void)
{
    switch (ISR_ExNum) {
    case 0:
        Sign_Isr = osSignalSet   (Var_ThreadId, 0x00000001);
        break;
    case 1:
        Sign_Isr = osSignalClear (Var_ThreadId, 0x00000001);
        break;
    case 2:
        Evnt_Isr = osSignalWait  (0x00000001,   0);
        break;
    case 3:
        Evnt_Isr = osSignalWait  (0x00000001, 100);
        break;
    }
}
