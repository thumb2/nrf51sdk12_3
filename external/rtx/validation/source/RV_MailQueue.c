...
void MailQueue_IRQHandler (void)
{
    ...
    switch (ISR_ExNum) {
    case 0:
        MailQId_Isr     = osMailCreate (osMailQ (MailQ_Isr), NULL);
        break;
    case 1:
        Mo_Isr          = (MAIL_OBJ *)osMailAlloc  (MailQ_Id,  0);
        break;
    case 2:
        Mo_Isr          = (MAIL_OBJ *)osMailAlloc  (MailQ_Id, 10);
        break;
    case 3:
        Mo_Isr          = (MAIL_OBJ *)osMailCAlloc (MailQ_Id,  0);
        break;
    case 4:
        Mo_Isr          = (MAIL_OBJ *)osMailCAlloc (MailQ_Id, 10);
        break;
    case 5:
        MailQ_Evt_Isr   = osMailGet (MailQ_Id, 0);
        break;
    case 6:
        MailQ_Stat_Isr  = osMailPut (MailQ_Id, Mo_Isr);
        break;
    case 7:
        MailQ_Stat_Isr  = osMailFree(MailQ_Id, Mo_Isr);
        break;
