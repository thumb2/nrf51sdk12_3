...
void Thread_IRQHandler (void)
{
    ...
    switch (ISR_ExNum) {
    case 0:
        ThId_Isr = osThreadCreate (osThread (Th_isr), NULL);
        break;
    case 1:
        ThId_Isr = osThreadGetId ();
        break;
    case 2:
        ThPr_Isr = osThreadGetPriority (ThId_Running);
        break;
    case 3:
        ThSt_Isr = osThreadSetPriority (ThId_Running, osPriorityIdle );
        break;
    case 4:
        ThSt_Isr = osThreadTerminate   (ThId_Running);
        break;
    case 5:
        ThSt_Isr = osThreadYield ();
        break;
    }
}
