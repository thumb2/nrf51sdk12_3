...
void MemoryPool_IRQHandler (void)
{
    ...
    switch (ISR_ExNum) {
    case 0:
        MemPool_IdIsr = osPoolCreate (osPool(MemPool_Isr));
        break;
    case 1:
        MemPtr_Isr[0] = osPoolAlloc (MemPool_IdIsr);
        break;
    case 2:
        MemPtr_Isr[1] = osPoolCAlloc(MemPool_IdIsr);
        break;
    case 3:
        MemPool_StIsr = osPoolFree  (MemPool_IdIsr, MemPtr_Isr[0]);
        break;
    case 4:
        MemPool_StIsr = osPoolFree  (MemPool_IdIsr, MemPtr_Isr[1]);
        break;
    }
}
