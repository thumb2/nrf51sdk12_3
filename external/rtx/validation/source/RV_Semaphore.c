...
void Semaphore_IRQHandler (void)
{
    ...
    switch (ISR_ExNum) {
    case 0:
        SemId_Isr = osSemaphoreCreate (osSemaphore (Sem_ISR), osFeature_Semaphore);
        break;
    case 1:
        NumTokens_Isr = osSemaphoreWait    (SemId_Isr,  0);
        break;
    case 2:
        NumTokens_Isr = osSemaphoreWait    (SemId_Isr, 10);
        break;
    case 3:
        SemSt_Isr     = osSemaphoreRelease (SemId_Isr);
        break;
    case 4:
        SemSt_Isr     = osSemaphoreDelete  (SemId_Isr);
        break;
    }
}
