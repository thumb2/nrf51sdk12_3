...
void MsgQueue_IRQHandler (void)
{
    ...
    case 0:
        ...
        break;
    case 1:
        MsgQSt_Isr = osMessagePut (MsgQId_Isr, 0x01,  0);
        break;
    case 2:
        MsgQSt_Isr = osMessagePut (MsgQId_Isr, 0x02, 10);
        break;
    case 3:
        MsgQEv_Isr = osMessageGet (MsgQId_Isr,  0);
        break;
    case 4:
        MsgQEv_Isr = osMessageGet (MsgQId_Isr, 10);
        break;
